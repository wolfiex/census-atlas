...
<ul class="ons-list ons-list--inline ons-list--bare ons-list--icons">
  <li class="ons-list__item">
    <span class="ons-list__prefix" aria-hidden="true">
      ...
      target="_blank"
      rel="noreferrer external">Facebook<span class="ons-u-vh">this link will open in a new tab</span></a
    >
  </li>
  <li class="ons-list__item">
    <span class="ons-list__prefix" aria-hidden="true">
      ...
      href={`https://twitter.com/intent/tweet?original_referer&amp;text=A page to share&amp;url=${url}`}
      class="ons-list__link  "
      target="_blank"
      rel="noreferrer external">Twitter<span class="ons-u-vh">this link will open in a new tab</span></a
    >
  </li>
  <li class="ons-list__item">
    <span class="ons-list__prefix" aria-hidden="true">
      ...
      class="ons-list__link  "
      target="_blank"
      rel="noreferrer external">Linkedin<span class="ons-u-vh">this link will open in a new tab</span></a
    >
  </li>
  <li class="ons-list__item">
    <span class="ons-list__prefix" aria-hidden="true">
      ...
      href={`https://mail.google.com/mail/?view=cm&fs=1&tf=1&body=${url}`}
      class="ons-list__link  "
      target="_blank"
      rel="noreferrer external">Email<span class="ons-u-vh">this link will open in a new tab</span></a
    >
  </li>
</ul>
